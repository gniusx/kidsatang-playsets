...
- RFID Tag หรือ RFID (Radio Frequency Identification) Tag คือ อุปกรณ์ที่เก็บข้อมูลในรูปแบบที่สามารถอ่านได้ผ่านคลื่นวิทยุ RFID Reader สามารถอ่านข้อมูลที่เก็บอยู่ในแท็กเหล่านี้ได้โดยไม่ต้องสัมผัส
- Keypad คือ แป้นพิมพ์ที่ประกอบด้วยปุ่มกด (มักเป็นแบบ 4x4 หรือ 3x4) ใช้ในงานที่ต้องมีการป้อนข้อมูลจากผู้ใช้ เช่นการป้อนรหัสผ่านหรือหมายเลข
- OLED คือ จอแสดงผลที่ใช้ไดโอดที่ปล่อยแสงเมื่อมีกระแสไฟฟ้าไหลผ่าน ข้อดีของจอ OLED คือมีความบางและใช้พลังงานน้อยกว่าจอแบบอื่น ๆ
- LED คือ ไดโอดที่สามารถปล่อยแสงเมื่อมีกระแสไฟฟ้าไหลผ่าน มักใช้เป็นไฟแสดงสถานะหรือเป็นแสงสว่างทั่วไปในโปรเจกต์อิเล็กทรอนิกส์ มีหลายขนาดและหลายสี นอกจากนี้ LED ยังสามารถนำไปใช้ในแถบไฟ LED (เช่น WS2812) ที่ควบคุมการเปลี่ยนสีได้ผ่านไมโครคอนโทรลเลอร์
- LCD คือ จอแสดงผลที่ใช้คริสตัลเหลวเพื่อแสดงข้อความหรือกราฟิก มักใช้ในรูปแบบจอขนาดเล็ก เช่น 16x2 หรือ 20x4 ตัวเลขหมายถึงจำนวนแถวและคอลัมน์ของตัวอักษรที่สามารถแสดงได้
